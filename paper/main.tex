...
fusion ($-23\%$) and int8$\rightarrow$int4 precision ($-50\%$). The entire flow
...
energy and reduces area by \approxs$23\%$ (Fig.~\ref{fig:precision}). This is the
hardware side of the trade only; whether int4 is usable depends on the accuracy
cost, which must be measured on the trained model and is left as an explicit
open input rather than estimated.
