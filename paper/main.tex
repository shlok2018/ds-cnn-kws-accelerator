...
analytically. The place-and-route is complete and DRC-clean, but the reported
$139$\,MHz is post-placement STA with estimated parasitics---the final sign-off
STA step did not run (a checker crash late in the flow), so it is a close
estimate rather than a signoff number---and the \approxs$263$\,mW is peak dynamic
...
studied. Future work is signoff-grade STA and power, an
