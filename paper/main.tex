...
scales explicitly in the comparison. The int4 accuracy is measured with
weights-only quantization and a short, CPU-bounded fine-tune; activation
quantization and a fuller precision sweep are future work. Finally, a single
workload and dataflow family are
